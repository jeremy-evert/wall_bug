"""Transcription command utilities for Wall_Bug."""
...
def _load_config_symbols() -> tuple[type[Any], Any]:
    try:
        ...
        legacy_module_name = "wallbug._transcribe_legacy_config"
        legacy_module_path = Path(__file__).resolve().parents[1] / "config.py"
